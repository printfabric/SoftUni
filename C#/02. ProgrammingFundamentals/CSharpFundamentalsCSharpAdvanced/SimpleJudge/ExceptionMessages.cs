...
namespace SimpleJudge
{
    ...
    {
        public const string ExamleExceptionMessage = "Examle message!";
        ...
        public const string UnableToGOHigherInPartitionHierarchy = "Exception UnableToGOHigherInPartitionHierarchy";
    }
}
